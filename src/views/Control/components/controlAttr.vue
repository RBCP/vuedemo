<template>
  <div style="margin-top:50px">
    <el-form :model="value"
             ...
             style="width:680px"
             size="small">
      <el-form-item label="Dept Code:" prop="dept">
...
<script>
  import {fetchListAll as fetchLocationtList} from '@/api/control'
  import {fetchList as fetchRankList} from '@/api/control'
  export default {
    name: "controlAttr",
    props:{
      value:Object,
    ...
    methods:{
      ...
      getLocationList(){
        fetchLocationtList().then(response=>{
